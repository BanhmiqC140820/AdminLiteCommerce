    ...
    public class OrderDAL : _BaseDAL, IOrderDAL
    {
        ...
        public IList<Order> List(int page = 1, int pageSize = 0, int status = 0, DateTime? fromTime = null, DateTime? toTime = null, string searchValue = "")
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                list = connection.Query<Order>(sql, param: parameters, commandType: System.Data.CommandType.Text).ToList();
                connection.Close();
            }
            return list;
        }
        ...
        public IList<OrderDetail> ListDetails(int orderID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                list = connection.Query<OrderDetail>(sql, param: parameters, commandType: System.Data.CommandType.Text).ToList();
                connection.Close();
            }
            return list;
        }
