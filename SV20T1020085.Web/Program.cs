...
builder.Services.AddControllersWithViews()
    .AddMvcOptions(opition =>
    {
        opition.SuppressImplicitRequiredAttributeForNonNullableReferenceTypes = true;
    });
...
SV20T1020085.BusinessLayers.Configuration.Initialize(connectionString);
